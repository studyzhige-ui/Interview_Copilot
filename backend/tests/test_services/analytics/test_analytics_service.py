...
def test_extract_records_reads_canonical_ability_signal_only(db_session):
    ...
    signal = AbilitySignal(
        ...
        score_scale_version="score100-legacy-v2",
        status="active",
    )
