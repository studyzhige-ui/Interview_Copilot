...
def _edit_doc(username: str, doc_type: str, payload: DocBodyRequest) -> dict:
    """Shared PUT core: lock + optimistic token check (MEM-3) → 409."""
    try:
...
def edit_user_profile(
    ...
    return _edit_doc(current_user.username, "user_profile", payload)
...
def edit_learning_strategy(
    ...
    return _edit_doc(current_user.username, "learning_strategy", payload)
