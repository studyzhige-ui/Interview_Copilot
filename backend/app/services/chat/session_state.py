"""Session-state serialization helpers (renamed from ``state_utils``).

Three session types are supported: ``general`` (free chat),
``debrief`` (post-interview review), and ``mock_interview``.
"""
