...
celery_app.conf.update(
    ...
    # ── Task routing ────────────────────────────────────────────────────
    # Five queues keep incompatible workloads from blocking one another:
    #
    ...
    # solo jobs worker subscribed to all four non-turn queues. Queue
    # subscription is the routing primitive in both cases.
