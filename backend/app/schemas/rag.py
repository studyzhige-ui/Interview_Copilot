...
class SourceKindEnum(str, Enum):
    """Knowledge-document source kinds exposed by the API.
    ...
    Conversation attachments are intentionally absent: they enter through the
    draft/claim API and are read by AttachmentRef, never by this library API.
    """
