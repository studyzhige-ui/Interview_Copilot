...
import { Archive, Bot, Clipboard, FilePlus2, FileText, Link2, Pencil, RefreshCw } from 'lucide-react';
import {
  archiveArtifact,
  createArtifact,
...
export function ArtifactsPage() {
  ...
  return <div className="mx-auto max-w-5xl space-y-5 p-4 md:p-6">
    ...
    <section className="rounded-xl border border-stone-200 bg-white p-4 shadow-xs">
      <h2 className="text-sm font-semibold text-stone-800">投递记录</h2>
      <p className="mt-1 text-xs text-stone-500">每条记录展示投递当时冻结的精确版本，不会替换成材料当前版本。</p>
